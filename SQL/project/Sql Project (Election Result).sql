...
-- 7. Total Seats Won by Each Party
-- BJP: 280+ seats
-- Congress: 150+ seats
-- Regional Parties: 113 seats combined

-- 9. Constituencies That Switched Parties
-- Some constituencies voted differently compared to the last election.
--  DEF Constituency switched from Congress to BJP.
-- Shows areas where voter sentiment is shifting, useful for future campaign strategies.

-- 10. Constituencies with Repeat Winners
-- Several candidates won re-election from their previous term.
-- Mr.Kamal (BJP) has won for the 3rd consecutive time in ABC Constituency.
-- Highlights areas with strong political loyalty and party dominance.
